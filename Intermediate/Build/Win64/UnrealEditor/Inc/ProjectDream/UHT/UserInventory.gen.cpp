...
PROJECTDREAM_API UClass* Z_Construct_UClass_UQuantityPrompt_NoRegister();
...
struct Z_Construct_UClass_UUserInventory_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_InventoryTopBar_MetaData[] = {
		{ "BindWidget", "" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "UMG/UserInventory.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_WeightText_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "UMG/UserInventory.h" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DropNumPromptClass_MetaData[] = {
		{ "Category", "UserInventory" },
		{ "ModuleRelativePath", "UMG/UserInventory.h" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DropNumPrompt_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "UMG/UserInventory.h" },
	};
#endif // WITH_METADATA
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_InventoryTopBar;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_InventoryDescription;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_WeightText;
	...
	static const UECodeGen_Private::FWeakObjectPropertyParams NewProp_Inventory;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_ButtonClose;
	static const UECodeGen_Private::FClassPropertyParams NewProp_DropNumPromptClass;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_DropNumPrompt;
	static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUserInventory_Statics::NewProp_InventoryTopBar = { "InventoryTopBar", nullptr, (EPropertyFlags)0x0144000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUserInventory, InventoryTopBar), Z_Construct_UClass_UHorizontalBox_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InventoryTopBar_MetaData), NewProp_InventoryTopBar_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUserInventory_Statics::NewProp_InventoryDescription = { "InventoryDescription", nullptr, (EPropertyFlags)0x0144000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUserInventory, InventoryDescription), Z_Construct_UClass_UHorizontalBox_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_InventoryDescription_MetaData), NewProp_InventoryDescription_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUserInventory_Statics::NewProp_WeightText = { "WeightText", nullptr, (EPropertyFlags)0x0144000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUserInventory, WeightText), Z_Construct_UClass_UTextBlock_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_WeightText_MetaData), NewProp_WeightText_MetaData) };
...
const UECodeGen_Private::FWeakObjectPropertyParams Z_Construct_UClass_UUserInventory_Statics::NewProp_Inventory = { "Inventory", nullptr, (EPropertyFlags)0x0044000000000000, UECodeGen_Private::EPropertyGenFlags::WeakObject, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUserInventory, Inventory), Z_Construct_UClass_UGameInventory_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Inventory_MetaData), NewProp_Inventory_MetaData) };
...
const UECodeGen_Private::FClassPropertyParams Z_Construct_UClass_UUserInventory_Statics::NewProp_DropNumPromptClass = { "DropNumPromptClass", nullptr, (EPropertyFlags)0x0044000000000001, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUserInventory, DropNumPromptClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UQuantityPrompt_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DropNumPromptClass_MetaData), NewProp_DropNumPromptClass_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UUserInventory_Statics::NewProp_DropNumPrompt = { "DropNumPrompt", nullptr, (EPropertyFlags)0x0144000000080008, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UUserInventory, DropNumPrompt), Z_Construct_UClass_UQuantityPrompt_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DropNumPrompt_MetaData), NewProp_DropNumPrompt_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UUserInventory_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUserInventory_Statics::NewProp_InventoryTopBar,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUserInventory_Statics::NewProp_InventoryDescription,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUserInventory_Statics::NewProp_WeightText,
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUserInventory_Statics::NewProp_DropNumPromptClass,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UUserInventory_Statics::NewProp_DropNumPrompt,
};
...
struct Z_CompiledInDeferFile_FID_ProjectDream_Source_ProjectDream_UMG_UserInventory_h__Script_ProjectDream_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UUserInventory, UUserInventory::StaticClass, TEXT("UUserInventory"), &Z_Registration_Info_UClass_UUserInventory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UUserInventory), 2085889707U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_ProjectDream_Source_ProjectDream_UMG_UserInventory_h__Script_ProjectDream_2061668525(TEXT("/Script/ProjectDream"),
